...
import { MLPCopilotClient } from "@/lib/mlpcopilot-client";
...
type BootState =
  ...
  | {
      status: "ready";
      client: MLPCopilotClient;
      token: string;
      modelName: string | null;
    };

const SIDEBAR_STORAGE_KEY = "mlpcopilot-webui.sidebar";
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const client = new MLPCopilotClient({
          url,
          onReauth: async () => {
            try {
