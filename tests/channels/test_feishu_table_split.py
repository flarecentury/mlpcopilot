...
table, allowing mlpcopilot to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from mlpcopilot.channels import feishu
...
from mlpcopilot.channels.feishu import FeishuChannel
