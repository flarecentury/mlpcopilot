...
Skip: live MLP/DP-GEN workflow status such as current iteration, current stage, queue counts, transient dispatcher errors, or temporary tracebacks; these must be refreshed from MCP tools or artifacts.
