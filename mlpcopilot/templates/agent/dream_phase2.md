...
- Do not write live DP-GEN status, current iteration/stage, queue counts, transient dispatcher errors, or temporary tracebacks into durable memory unless the analysis explicitly says the user requested a historical note.
