"""Utility functions for mlpcopilot."""
...
_TOOL_RESULTS_DIR = ".mlpcopilot/tool-results"
...
def build_status_content(
    *,
    ...
    lines = [
        f"\U0001f408 mlpcopilot v{version}",
...
def sync_workspace_templates(workspace: Path, silent: bool = False) -> list[str]:
    ...
    try:
        tpl = pkg_files("mlpcopilot") / "templates"
    except Exception:
        return []
    if not tpl.is_dir():
        return []
