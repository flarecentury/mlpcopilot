...
from mlpcopilot.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
...
from mlpcopilot.config.schema import AgentDefaults, ExecToolConfig, WebToolsConfig
...
class SubagentManager:
    ...
    async def _run_subagent(
        ...
        try:
            ...
            tools.register(ListDirTool(workspace=self.workspace, allowed_dir=allowed_dir, extra_allowed_dirs=extra_read, file_states=file_states))
            tools.register(GlobTool(workspace=self.workspace, allowed_dir=allowed_dir, extra_allowed_dirs=extra_read, file_states=file_states))
            tools.register(GrepTool(workspace=self.workspace, allowed_dir=allowed_dir, extra_allowed_dirs=extra_read, file_states=file_states))
