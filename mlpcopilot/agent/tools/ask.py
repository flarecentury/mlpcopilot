...
from mlpcopilot.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
...
class AskUserTool(Tool):
    ...
    def description(self) -> str:
        return (
            ...
            "Do not use this to ask permission for read-only tool calls, file listing, file sizes, or shell/status checks; "
            "runtime approval policy handles tool permission. "
