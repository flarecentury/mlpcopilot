...
echo "mlpcopilot line count"
echo "=================="
echo ""

echo "Core runtime"
echo "------------"
core_agent=$(count_top_level_py_lines "mlpcopilot/agent")
core_bus=$(count_top_level_py_lines "mlpcopilot/bus")
core_config=$(count_top_level_py_lines "mlpcopilot/config")
core_cron=$(count_top_level_py_lines "mlpcopilot/cron")
core_heartbeat=$(count_top_level_py_lines "mlpcopilot/heartbeat")
core_session=$(count_top_level_py_lines "mlpcopilot/session")
...
echo "----------------"
extra_tools=$(count_recursive_py_lines "mlpcopilot/agent/tools")
extra_skills=$(count_skill_lines "mlpcopilot/skills")
extra_api=$(count_recursive_py_lines "mlpcopilot/api")
extra_cli=$(count_recursive_py_lines "mlpcopilot/cli")
extra_channels=$(count_recursive_py_lines "mlpcopilot/channels")
extra_utils=$(count_recursive_py_lines "mlpcopilot/utils")
...
echo "Notes"
echo "-----"
echo "  - agent/ only counts top-level Python files under mlpcopilot/agent"
echo "  - tools/ is counted separately from mlpcopilot/agent/tools"
echo "  - skills/ counts .md, .py, and .sh files"
echo "  - not included here: command/, providers/, security/, templates/, mlpcopilot.py, root files"
